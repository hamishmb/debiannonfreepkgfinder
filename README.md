...
```
cd existing_repo
git remote add origin https://gitlab.com/hamishmb/debiannonfreepkgfinder.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/hamishmb/debiannonfreepkgfinder/-/settings/integrations)
